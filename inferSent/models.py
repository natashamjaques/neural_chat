...
class InferSent(nn.Module):
    ...
    def copy(self, inp):
        ...
        # but to keep consistent with the above constructor that gets config rather than a model,
        # had to implement it as a non-constructor function
        self.bsize = inp.bsize
        self.word_emb_dim = inp.word_emb_dim
        self.enc_lstm_dim = inp.enc_lstm_dim
        self.pool_type = inp.pool_type
        self.dpout_model = inp.dpout_model
        self.version = inp.version
        self.enc_lstm = nn.LSTM(self.word_emb_dim, self.enc_lstm_dim, 1,
                                bidirectional=True, dropout=self.dpout_model)
        ...
        self.set_w2v_path(inp.w2v_path)
        self.word_vec = inp.word_vec
        return self
