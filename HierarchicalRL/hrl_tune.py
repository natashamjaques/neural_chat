...
if __name__ == '__main__':
    ...
    kwargs_dict = vars(parser.parse_args(['--checkpoint', '/u/a_saleh/projects/dialog-eq/model_checkpoints/reddit_casual/human_eval_models/vhred_new_hparams/',
                                          '-r', 'reward_bot_deepmoji', 'reward_question', 'reward_toxicity', 'reward_conversation_repetition', 'reward_USE_similarity',
                                          '-w', '0.3', '0.15', '0.1', '0.3', '0.15',
                                          '--encoder_steps', '10', '--decoder_steps', '10', '--joint_steps', '10',
                                          '--freeze_simulator',
                                          '--dropout', '0.0',
                                          '--num_iterations', '100',
                                          '--save_every_n', '10',
                                          ...
                                          '--decoder_learning_rate', '0.000002',
                                          '--gamma', '0.0',
                                          '--normalize_word_probs',
                                          '--normalize_rewards_Z',
                                          '--save_checkpoints', '--joint_hrl',
                                          '--enc_action_weight', '0.01'
                                          ]))

    # kwargs_dict = vars(parser.parse_args(['--checkpoint', '/u/a_saleh/projects/dialog-eq/model_checkpoints/reddit_casual/human_eval_models/vhred_new_hparams/',
    #                                       '-r', 'reward_USE_similarity', '-w', '1.0',
    #                                       '--encoder_steps', '10', '--decoder_steps', '10', '--joint_steps', '10',
    #                                       '--freeze_simulator',
    #                                       '--dropout', '0.0',
    #                                       '--num_iterations', '50',
    ...
    #                                       '--normalize_rewards_Z',
    #                                       '--save_checkpoints', '--joint_hrl',
    #                                       '--enc_action_weight', '0.1'
    #                                       ]))


    # kwargs_dict = vars(parser.parse_args(['--checkpoint', '/u/a_saleh/projects/dialog-eq/model_checkpoints/reddit_casual/human_eval_models/vhred_new_hparams/',
    #                                       '-r', 'reward_toxicity', '-w', '1.0',
    #                                       '--encoder_steps', '10', '--decoder_steps', '10', '--joint_steps', '10',
    #                                       '--freeze_simulator',
    #                                       '--dropout', '0.0',
    #                                       '--num_iterations', '50',
    ...
    # kwargs_dict = vars(parser.parse_args(['--checkpoint', '../../model_checkpoints/reddit_casual/human_eval_models/vhred_new_hparams/',
    #                                      '-r', 'reward_toxicity', '-w', '1.0',
    #                                      '--encoder_steps', '10', '--decoder_steps', '10',
    #                                      '--freeze_simulator',
    #                                      '--dropout', '0.0',
    #                                      '--num_iterations', '50',
    #                                      '--save_every_n', '50000000',
    #                                      '--summary_every_n', '1',
    #                                      '--log_every_n', '1',
    #                                      '--rl_batch_size', '4',
    #                                      '--episode_len', '3',
